...
test1_df = pd.read_csv('test_CLD_v2.ASC', skiprows = 8, delimiter = '\t')
...
corrected_df = test1_df.drop([2356])
conc_df2 = conc_df.drop([2356])
...
#%%
diff = stable_SlCol_O3 - stable_SlCol_O3_no_CLD

#%%

plt.plot(stable_Datetime, diff)
plt.title('SlCol(O3)')

# -*- coding: utf-8 -*-
"""
Created on Mon Jan  9 14:25:20 2023
...
test1_df = pd.read_csv('test_IO_O4.ASC', skiprows = 8, delimiter = '\t')
...
corrected_df = test1_df.drop([2360])
conc_df2 = conc_df.drop([2360])
...
stable_RMS = conc_df2['Test.RMS'][lower_lim:upper_lim]
...
plt.plot(stable_Datetime, stable_RMS)
plt.title('RMS')
plt.xlabel('Date Time')
plt.ylabel('RMS')
plt.show()
...
peaks, _ = find_peaks(stable_RMS, height=0.0004)
